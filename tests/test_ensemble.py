...
from chuzom import ensemble
from chuzom.classify import apply_complexity_floor, classify_signals
...
async def test_classify_for_routing_uses_ensemble_when_enabled(monkeypatch):
    monkeypatch.setenv("CHUZOM_ENSEMBLE", "on")
    called = {}
...
async def test_classify_for_routing_defers_to_cloud_when_disabled(monkeypatch):
    ...
    import chuzom.classifier as clf
    called = {}
