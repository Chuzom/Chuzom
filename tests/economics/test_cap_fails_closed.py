...
def _isolated_db(tmp_path, monkeypatch):
    ...
    CHUZOM_HOME does not isolate cost._get_db(); that gap destroyed real data
...
async def test_the_failure_is_counted_not_just_denied():
    ...
    from chuzom import cost, failopen
...
def test_display_renders_unknown_not_infinity():
    ...
    from chuzom.cost import format_spend_for_display
...
async def test_release_retries_once_before_giving_up():
    ...
    from chuzom.quota_envelope_routing import release_envelope
