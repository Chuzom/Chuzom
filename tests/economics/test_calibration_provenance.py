...
WP-05's rule is already implemented in ``chuzom.provenance``: an estimated figure
...
def test_predict_cost_still_returns_the_same_number():
    ...
    from chuzom.calibration import predict_cost, predict_cost_measured
...
def test_calibration_coverage_is_reportable():
    ...
    """
    from chuzom.calibration import calibration_coverage
