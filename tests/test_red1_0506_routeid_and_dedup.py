...
enforce = _load(ENFORCE_HOOK, "chuzom_enforce_route_routeid")
stop = _load(STOP_HOOK, "chuzom_stop_enforce_routeid")
...
def test_pending_json_carries_stable_route_id(tmp_path):
    ...
    'route_id'."""
    text = (ROOT / "src" / "chuzom" / "hooks" / "auto-route.py").read_text()
