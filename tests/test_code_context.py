...
class TestPromptDerivedPathsAreConfined:
    """CodeQL py/path-injection, src/chuzom/code_context.py.
    ...
    forwarding context is what chuzom does.
...
class TestFilePathRegexIsBounded:
    """CodeQL py/polynomial-redos, src/chuzom/code_context.py.
    ...
    def test_real_paths_are_unchanged_by_the_bound(self):
        found = detect_file_paths(
            "see src/chuzom/router.py and lib/mod.rs plus a.b.c.js"
        )
        assert "src/chuzom/router.py" in found
