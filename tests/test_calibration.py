"""Tests for src/chuzom/calibration.py — Plan 07 Cat F (Cost realism).
...
class TestTokenShapeProfile:
    ...
    def test_is_frozen(self):
        ...
        from chuzom.calibration import TokenShapeProfile
...
class TestProjectionCheck:
    ...
    def test_no_warning_within_threshold(self, caplog):
        ...
        from chuzom.calibration import projection_check
