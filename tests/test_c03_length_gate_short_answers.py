...
from chuzom.contract import build_contract, _TERSE_ANSWER_TASKS
from chuzom.gates import run_gates, _is_valid_short_answer
from chuzom.contract import GateType
from chuzom.types import Complexity
from chuzom.router import TaskType


@pytest.fixture(autouse=True)
def _force_gates_on(monkeypatch):
    # run_gates auto-skips under pytest unless CHUZOM_GATES=on — force it so these
