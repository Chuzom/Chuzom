...
from chuzom.hooks.agent_loop import _get_ollama_url as agent_loop_url
from chuzom.hooks.direct_executor import _get_ollama_url as direct_executor_url
...
def test_hostile_urls_fail_closed(monkeypatch, reader_name, hostile, label):
    ...
    monkeypatch.setenv("CHUZOM_OLLAMA_URL", hostile)
