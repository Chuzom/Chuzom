...
correctly against an empty, sandboxed ~/.chuzom (no usage.db present),
...
computed via os.path.expanduser("~/.chuzom") at import time, same
...
HOOK_PATH = Path(__file__).parent.parent / "src" / "chuzom" / "hooks" / "session-end.py"
