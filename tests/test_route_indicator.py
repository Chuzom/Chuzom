...
def test_format_echo_context_renders_real_data() -> None:
    ...
    expected_prefix = "🎯 Chuzom routed → gemini/gemini-2.5-flash · query/simple · 1.5s"
...
def test_no_double_prefix_across_paths() -> None:
    """Both paths use the same ``🎯 Chuzom routed →`` marker so the user sees one
