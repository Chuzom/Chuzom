...
from chuzom.chain_builder import _static_chain
from chuzom.profiles import ROUTING_TABLE, base_lookup_profile, get_model_chain
...
def test_reordering_profiles_are_not_their_own_base():
    ...
    from chuzom.profiles import _REORDERING_PROFILE_BASE
...
async def test_memory_profile_lookup_returns_a_model_id(monkeypatch):
    ...
    from chuzom.memory import profiles as memory_profiles
