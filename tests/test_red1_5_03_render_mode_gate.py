"""Regression: RED1-5-03 — explicit CHUZOM_RENDER_MODE=echo must never be
force-blocked, even when CHUZOM_ZERO_CLAUDE is also set.
...
def _load():
    spec = importlib.util.spec_from_file_location("chuzom_auto_route_red1503", HOOK_PATH)
