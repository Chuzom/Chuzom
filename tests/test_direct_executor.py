...
class TestExecuteChain:
    def test_skips_claude_models(self):
        ...
        with patch("chuzom.hooks.direct_executor.ollama_is_alive", return_value=True), \
             patch("chuzom.hooks.direct_executor.call_ollama", return_value=("test response here", {})):
    ...
    def test_returns_none_when_all_fail(self):
        ...
        with patch("chuzom.hooks.direct_executor.ollama_is_alive", return_value=True), \
             patch("chuzom.hooks.direct_executor.call_ollama", return_value=(None, {})), \
    ...
    def test_tries_models_in_order(self):
        ...
        with patch("chuzom.hooks.direct_executor.ollama_is_alive", return_value=True), \
             patch("chuzom.hooks.direct_executor.call_ollama", return_value=("ollama says hi", {})), \
    ...
    def test_falls_through_on_quality_failure(self):
        ...
        with patch("chuzom.hooks.direct_executor.ollama_is_alive", return_value=True), \
             patch("chuzom.hooks.direct_executor.call_ollama", return_value=("ok", {})), \
