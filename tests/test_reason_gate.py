...
from chuzom import reason_gate as rg
from chuzom.classify import _COMPLEXITY_DEEP, complexity_for, HOOK_POLICY
from chuzom.types import Complexity, Subject
...
def test_artifact_overrides_weights(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("CHUZOM_SEMANTIC_CENTROIDS", str(path))
    rg._load_gate_params.cache_clear()
