...
from chuzom.discover import _is_embedding_model, _update_discovery_cache
from chuzom.router import _build_and_filter_chain, provider_from_model
...
def test_discovery_cache_excludes_embedding_models(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("chuzom.discover._DISCOVERY_CACHE", str(cache))
