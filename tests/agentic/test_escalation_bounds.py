...
class _NeverPasses:
    ...
    def run(self, milestone, context, budget_left):  # noqa: ANN001, ARG002
        from chuzom.agentic.adapters import AgentRunResult
...
def _never_ok(milestone, artifacts):  # noqa: ANN001, ARG001
    from chuzom.agentic.acceptance import AcceptanceResult
...
def test_planner_accepts_a_plan_at_the_cap():
    ...
    from chuzom.agentic.planner import MAX_PLAN_MILESTONES, plan_to_milestones
