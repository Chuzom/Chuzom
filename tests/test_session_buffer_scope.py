...
The fix (``src/chuzom/context.py``) replaces the singleton with a bounded,
...
class TestResolveContextIdentity:
    ...
    def test_explicit_project_id_wins_outright(self, monkeypatch):
        monkeypatch.setenv("CHUZOM_PROJECT_ID", "env-project")
    ...
    def test_fails_open_on_session_store_import_error(self, monkeypatch):
        ...
        def _blocking_import(name, *args, **kwargs):
            if name == "chuzom.session_store" or name == "chuzom":
