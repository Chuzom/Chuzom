...
1. **ClassificationCache** (legacy, ported from llm-router):
       ...
       identical prompts. Imported as `from tessera.cache import get_cache`.
...
2. **SemanticCache** (v0.0.2 stub, sqlite-vec backend in v0.0.2 impl):
       ...
       Imported as `from tessera.cache import SemanticCache`.
...
"""
from tessera.cache.classification import (
    CacheEntry,
    CacheStats,
    ClassificationCache,
    get_cache,
)
from tessera.cache.store import SemanticCache, SemanticCacheEntry
