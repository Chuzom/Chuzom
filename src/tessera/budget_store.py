"""Persistent budget cap storage for tessera.

Caps are stored in ``~/.tessera/budgets.json`` and take priority over
environment-variable caps (``TESSERA_BUDGET_OPENAI``, etc.).
...
Usage::
    ...
    from tessera.budget_store import get_caps, set_cap, remove_cap
