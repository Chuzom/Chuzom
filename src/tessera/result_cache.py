...
Two cache levels:
- **User-level** (~/.tessera/result_cache.db): knowledge Q&A, research
- **Project-level** (~/.tessera/projects/<hash>/result_cache.db): code answers
...
log = logging.getLogger("tessera.result_cache")
