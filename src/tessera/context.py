...
from tessera.context_optimizer import ContextOptimizationResult, optimize_context
...
def _get_db_path() -> Path:
    ...
    return get_config().tessera_db_path
...
async def build_context_messages(
    *,
    ...
    try:
        import os
        optimizer_mode = os.getenv("TESSERA_CONTEXT_OPTIMIZER", "auto").lower()
