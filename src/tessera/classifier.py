...
from tessera.profiles import CLASSIFIER_MODELS, provider_from_model
from tessera.sanitization import sanitize_prompt
from tessera.tracing import set_span_attributes, traced_span
from tessera.types import ClassificationResult, Complexity, Subject, TaskType

log = get_logger("tessera.classifier")
...
async def classify_complexity(
    ...
    with traced_span(
        "classify_complexity",
        tracer_name="tessera.classifier",
