...
D.1–D.3 patched provider-specific quirks inline in :mod:`tessera.providers`:
...
def register_quirk(provider: str, quirk: ProviderQuirk) -> None:
    ...
    Replace-by-default mirrors :mod:`tessera.benchmark`'s registry — tests
...
def get_quirk(provider: str) -> ProviderQuirk:
    ...
    plumbing throughout :mod:`tessera.providers`.
    """
