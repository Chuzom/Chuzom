...
log = get_logger("tessera.profiles")
...
# rate-limiting.
#
# Source of truth: src/tessera/policies/standard.yaml. This dict is
...
# src/tessera/policies/standard.yaml.
...
def get_model_chain(
    ...
    try:
        from tessera.policy import get_active_policy
