"""Service manager for tessera sidecar.
...
logger = logging.getLogger("tessera.service-manager")

ROUTER_DIR = Path.home() / ".tessera"
SERVICE_PID_FILE = ROUTER_DIR / "service.pid"
SERVICE_PORT = int(os.environ.get("TESSERA_SERVICE_PORT", "7337"))
...
def start_service() -> bool:
    ...
    try:
        ...
        proc = subprocess.Popen(
            ...
            env={**os.environ, "TESSERA_SERVICE_PORT": str(SERVICE_PORT)},
        )
