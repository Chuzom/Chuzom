...
def cmd_status(args: list[str]) -> int:
    ...
    print(f"\n  {_bold('Subcommands')}")
    print(f"    {_bold('tessera update')}     — update hooks to latest version")
    print(f"    {_bold('tessera doctor')}     — full health check")
    print(f"    {_bold('tessera dashboard')}  — web dashboard (localhost:7337)")
    print("─" * WIDTH + "\n")
