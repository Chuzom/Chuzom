#!/usr/bin/env python3
"""tessera last — Show the most recent routing decisions (real-time feedback).

Command: uv run tessera last [--count N]
...
from tessera.terminal_style import Color, Symbol
...
def print_recent_decisions(decisions: list[dict]) -> None:
    ...
    """
    if not decisions:
        print("No routing decisions yet. Use tessera to route your first request.")
        return
