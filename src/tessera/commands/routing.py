...
def _run_routing() -> None:
    ...
    print(f"\n{'─' * min(w, 70)}")
    print(_dim("Run: tessera status     # Usage & savings"))
    print(_dim("Run: tessera routing    # This command"))
    print(_dim("Run: tessera budget     # Budget management\n"))


# ── Entry point ─────────────────────────────────────────────────────────────

def cmd_routing(args: list[str]) -> int:
    """Execute: tessera routing
