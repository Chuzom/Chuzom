...
LEARNED_ROUTES_FILE = Path.home() / ".tessera" / "learned_routes.json"
...
def save_learned_profile(profile: dict[str, LearnedRoute]) -> Path:
    """Save learned profile to ~/.tessera/learned_routes.json.
...
def load_learned_profile() -> dict[str, LearnedRoute]:
    """Load learned profile from ~/.tessera/learned_routes.json.
