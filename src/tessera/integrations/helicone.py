"""Helicone integration for tessera.

When ``HELICONE_API_KEY`` is set, tessera can:
  ...
  **Pull** — query Helicone's usage API to get per-model spend data,
  ...
  traffic is routed outside tessera (e.g. direct SDK calls from your
...
Optional::
    ...
    export TESSERA_HELICONE_PULL=true   # pull spend data (default: false)
...
_PULL_ENABLED_ENV = "TESSERA_HELICONE_PULL"
