...
Opt-in anonymous sharing is gated behind TESSERA_COMMUNITY=true. In v3.4
...
log = logging.getLogger("tessera.community")

_COMMUNITY_EXPORT_PATH = Path.home() / ".tessera" / "community_export.jsonl"
...
async def prepare_community_export() -> str:
    ...
    Data is written to ~/.tessera/community_export.jsonl.
