...
log = logging.getLogger("tessera.semantic_cache")
...
def _get_threshold() -> float:
    ...
    try:
        return float(os.getenv("TESSERA_SEMANTIC_CACHE_THRESHOLD", str(DEFAULT_THRESHOLD)))
    except ValueError:
    ...
    *,
    ...
    Args:
        ...
        threshold: Cosine similarity threshold (0–1). Uses
            ``TESSERA_SEMANTIC_CACHE_THRESHOLD`` env var or 0.95 default.
