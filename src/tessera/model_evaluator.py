...
Results cached to ~/.tessera/model_evals.json (7-day TTL).
"""
...
from tessera.codex_agent import is_codex_available, run_codex
from tessera.config import get_config

log = get_logger("tessera.model_evaluator")

EVAL_CACHE_PATH = Path.home() / ".tessera" / "model_evals.json"
EVAL_TTL_DAYS = 7
