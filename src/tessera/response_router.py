...
class ResponseRouter:
    ...
    - TESSERA_RESPONSE_ROUTER: "on" (enabled) | "off" (disabled, fallback to native)
    - TESSERA_RESPONSE_ROUTER_COMPLEXITY: "simple" | "moderate" (default: simple)
    - TESSERA_RESPONSE_ROUTER_TOKEN_THRESHOLD: min tokens to route (default: 300)
    """

    ENABLED: bool = os.environ.get("TESSERA_RESPONSE_ROUTER", "on").lower() == "on"
    COMPLEXITY: Complexity = Complexity.SIMPLE
    MIN_TOKENS: int = int(os.environ.get("TESSERA_RESPONSE_ROUTER_TOKEN_THRESHOLD", "300"))
    ...
    async def route_response(self, response: str) -> str:
        ...
        try:
            ...
            from tessera.tools.text import llm_generate
