...
from tessera.edit import build_edit_prompt, format_edit_result, parse_edit_response, read_file_for_edit
...
async def llm_fs_analyze_context(
    ...
    ~/.tessera/context_summary.json. Subsequent routing decisions inject
...
Return ONLY the JSON object."""
    ...
    summary_path = _Path.home() / ".tessera" / "context_summary.json"
    try:
