...
Status as of v0.0.2:
    ...
    - pydantic_ai  — stub
"""
from tessera.frameworks.base import FrameworkAdapter

__all__ = ["FrameworkAdapter"]


# Concrete adapters are lazy-imported below so users without the framework
# installed don't get ImportError on `from tessera.frameworks import ...`.
...
def get_hermes_adapter():
    ...
    from tessera.frameworks import hermes
