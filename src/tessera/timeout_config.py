...
- TESSERA_REQUEST_TIMEOUT: HTTP request timeout in seconds (default: 120)
- TESSERA_MEDIA_REQUEST_TIMEOUT: Media generation timeout (default: 600)
- TESSERA_CODEX_TIMEOUT: Codex CLI execution timeout (default: 300)
- TESSERA_SUBPROCESS_TIMEOUT: Hook/tool subprocess timeout (default: 15)
- TESSERA_HTTP_TIMEOUT: Quick HTTP operations (default: 10)
- TESSERA_BENCHMARK_TIMEOUT: Benchmark fetch timeout (default: 30)
"""
...
def get_timeout_config() -> dict[str, int]:
    ...
    env_mapping = {
        "request_timeout": "TESSERA_REQUEST_TIMEOUT",
        "media_request_timeout": "TESSERA_MEDIA_REQUEST_TIMEOUT",
        "codex_timeout": "TESSERA_CODEX_TIMEOUT",
        "subprocess_timeout": "TESSERA_SUBPROCESS_TIMEOUT",
        "http_timeout": "TESSERA_HTTP_TIMEOUT",
        "benchmark_timeout": "TESSERA_BENCHMARK_TIMEOUT",
    }
...
def request_timeout() -> int:
    ...
    Set via TESSERA_REQUEST_TIMEOUT environment variable.
    """
...
def media_request_timeout() -> int:
    ...
    Set via TESSERA_MEDIA_REQUEST_TIMEOUT environment variable.
    """
...
def codex_timeout() -> int:
    ...
    Set via TESSERA_CODEX_TIMEOUT environment variable.
    """
...
def subprocess_timeout() -> int:
    ...
    Set via TESSERA_SUBPROCESS_TIMEOUT environment variable.
    """
...
def http_timeout() -> int:
    ...
    Set via TESSERA_HTTP_TIMEOUT environment variable.
    """
...
def benchmark_timeout() -> int:
    ...
    Set via TESSERA_BENCHMARK_TIMEOUT environment variable.
    """
