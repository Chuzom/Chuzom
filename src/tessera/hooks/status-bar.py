...
Provider health: read from ~/.tessera/health.json (written by background checks).
Enforcement mode: read from TESSERA_ENFORCE env var.
"""
...
# ── Config ─────────────────────────────────────────────────────────────────
STATUS_EVERY = os.environ.get("TESSERA_STATUS_EVERY", "0")
STATUS_MODE = os.environ.get("TESSERA_STATUS_MODE", "compact")  # compact | full
ENFORCE_MODE = os.environ.get("TESSERA_ENFORCE", "hard").lower()
