...
Env vars:
  ...
  TESSERA_OLLAMA_MODEL         Model for compression (default: qwen2.5:7b)
  GEMINI_API_KEY                  Enables Gemini Flash fallback
  TESSERA_PLAYWRIGHT_COMPRESS  Set to "off" to disable this hook
"""
...
OLLAMA_MODEL = os.environ.get("TESSERA_OLLAMA_MODEL", "qwen2.5:7b")
...
def main() -> None:
    ...
    if os.environ.get("TESSERA_PLAYWRIGHT_COMPRESS", "").lower() == "off":
        sys.exit(0)
