...
> These rules apply when using tessera MCP tools inside Gemini CLI (google-gemini/gemini-cli).
...
Gemini CLI loads MCP servers from `~/.gemini/settings.json`. Once tessera is
