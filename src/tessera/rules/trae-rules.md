...
> These rules apply when using tessera MCP tools inside Trae IDE (ByteDance).
...
Trae loads MCP servers from the mcpServers config block. Once tessera is registered,
