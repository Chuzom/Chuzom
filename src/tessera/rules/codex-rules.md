...
This document explains how to use tessera MCP tools within the Codex CLI agent.

## Available MCP Tools

When Codex CLI has the tessera plugin registered, the following MCP tools are available:
...
When using Codex CLI with tessera, prefer output that:
