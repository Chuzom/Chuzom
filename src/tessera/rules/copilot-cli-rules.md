...
> These rules apply when using tessera MCP tools inside GitHub Copilot CLI.
...
Copilot CLI loads MCP servers from the project or global config. Once tessera is
