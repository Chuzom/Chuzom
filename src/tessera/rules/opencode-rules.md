# tessera Routing Rules for OpenCode
...
When using tessera, responses use a token-efficient preamble style:
...
The tessera MCP server is configured in `~/.config/opencode/config.json` with:
