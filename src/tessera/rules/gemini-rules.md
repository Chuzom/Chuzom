# tessera Routing Rules for Gemini CLI

Configure tessera for Gemini CLI with smart LLM routing.
...
The tessera extension is configured in `~/.gemini/extensions/tessera/` with:
