...
PXPIPE_URL="${CHUZOM_PXPIPE_URL:-http://127.0.0.1:47821}"
PXPIPE_MODELS_ENV="${CHUZOM_PXPIPE_HEAVY_MODELS:-claude-fable-5}"
...
if ! is_running; then
    ...
    # which models pxpipe itself compresses — pass through Chuzom's own
