...
Provider health: read from ~/.chuzom/health.json (written by background checks).
Enforcement mode: read from CHUZOM_ENFORCE env var.
"""
...
# ── Config ─────────────────────────────────────────────────────────────────
STATUS_EVERY = os.environ.get("CHUZOM_STATUS_EVERY", "0")
