...
to the canonical chuzom SQLite database (~/.chuzom/usage.db) so the
...
try:
    ...
    # it imported nothing from chuzom, so this degradation path is new and has
...
#
# WP-03: derived from chuzom.pricing. Every one of the three literals here was
