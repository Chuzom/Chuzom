...
# Defence in depth:
#   1. Tools are NOT registered unless `CHUZOM_FS_TOOLS=on` (gate at register()).
...
async def llm_fs_analyze_context(
    ...
    ~/.chuzom/context_summary.json. Subsequent routing decisions inject
...
Return ONLY the JSON object."""
    ...
    summary_path = _Path.home() / ".chuzom" / "context_summary.json"
    try:
