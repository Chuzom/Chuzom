"""Service manager for chuzom sidecar.
...
logger = logging.getLogger("chuzom.service-manager")

ROUTER_DIR = Path.home() / ".chuzom"
SERVICE_PID_FILE = ROUTER_DIR / "service.pid"
SERVICE_PORT = int(os.environ.get("CHUZOM_SERVICE_PORT", "7337"))
...
def start_service() -> bool:
    ...
    try:
        ...
        proc = subprocess.Popen(
            ...
            env={**os.environ, "CHUZOM_SERVICE_PORT": str(SERVICE_PORT)},
        )
