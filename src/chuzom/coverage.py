"""Routing coverage — how much traffic Chuzom did NOT observe.
...
Every rate Chuzom reports is a fraction of *observed* traffic. Without a count of
...
class Reason(Enum):
    ...
    #: A chuzom-debug prompt about chuzom itself; routing it would be circular.
...
def store_path():
    """Path to the coverage store, inside CHUZOM_HOME when isolated."""
