...
Cost projection uses :func:`chuzom.calibration.predict_cost` so the
...
def format_diff_report(report: PolicyDiffReport) -> str:
    ...
    Kept out of :mod:`chuzom.commands.policy` so non-CLI callers (tests,
