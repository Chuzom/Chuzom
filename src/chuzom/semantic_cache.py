...
log = logging.getLogger("chuzom.semantic_cache")
...
def _get_threshold() -> float:
    ...
    try:
        return float(os.getenv("CHUZOM_SEMANTIC_CACHE_THRESHOLD", str(DEFAULT_THRESHOLD)))
    except ValueError:
    ...
    *,
    ...
    Args:
        ...
        threshold: Cosine similarity threshold (0–1). Uses
            ``CHUZOM_SEMANTIC_CACHE_THRESHOLD`` env var or 0.95 default.
