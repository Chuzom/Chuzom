...
class ResponseRouter:
    ...
    - CHUZOM_RESPONSE_ROUTER: "on" (enabled) | "off" (disabled, fallback to native)
    - CHUZOM_RESPONSE_ROUTER_COMPLEXITY: "simple" | "moderate" (default: simple)
    - CHUZOM_RESPONSE_ROUTER_TOKEN_THRESHOLD: min tokens to route (default: 300)
    """

    ENABLED: bool = os.environ.get("CHUZOM_RESPONSE_ROUTER", "on").lower() == "on"
    COMPLEXITY: Complexity = Complexity.SIMPLE
    MIN_TOKENS: int = int(os.environ.get("CHUZOM_RESPONSE_ROUTER_TOKEN_THRESHOLD", "300"))
    ...
    async def route_response(self, response: str) -> str:
        ...
        try:
            ...
            from chuzom.tools.text import llm_generate
