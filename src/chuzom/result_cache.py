...
Two cache levels:
- **User-level** (~/.chuzom/result_cache.db): knowledge Q&A, research
- **Project-level** (~/.chuzom/projects/<hash>/result_cache.db): code answers
...
log = logging.getLogger("chuzom.result_cache")
