"""Library store — OKF document read/write for .chuzom/context/.
...
CONTEXT_DIRNAME = ".chuzom/context"
...
class LibraryStore:
    ...
    def ensure_layout(self) -> None:
        ...
        gi = self.root.parent / ".gitignore"  # .chuzom/.gitignore
        marker = "context/"
