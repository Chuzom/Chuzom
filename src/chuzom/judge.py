...
Sample rate: CHUZOM_JUDGE_SAMPLE_RATE (default 0.1 = 10% of calls).
...
async def evaluate_response_async(
    ...
    sample_rate = float(__import__("os").environ.get("CHUZOM_JUDGE_SAMPLE_RATE", "0.1"))
