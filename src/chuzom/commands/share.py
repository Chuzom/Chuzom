...
def _run_share() -> None:
    ...
    card_lines = [
        f"┌{border}┐",
        _box_line(""),
        _box_line(f"  🤖 chuzom saved me ${total_saved:.2f} (lifetime)"),
        ...
        _box_line(""),
        _box_line("  ⭐ github.com/ypollak2/chuzom"),
        _box_line(""),
        f"└{border}┘",
    ]
    ...
    plain = (
        f"🤖 chuzom saved me ${total_saved:.2f} (lifetime)\n"
        ...
        f"⭐ github.com/ypollak2/chuzom"
    )
    _copy_to_clipboard(plain)

    # ── Twitter/X intent URL ──────────────────────────────────────────
    tweet = (
        f"🤖 chuzom saved me ${total_saved:.2f} so far "
        f"({savings_pct}% cheaper than always-Sonnet)\n\n"
