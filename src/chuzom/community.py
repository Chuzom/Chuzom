...
Opt-in anonymous sharing is gated behind CHUZOM_COMMUNITY=true. In v3.4
...
log = logging.getLogger("chuzom.community")

_COMMUNITY_EXPORT_PATH = Path.home() / ".chuzom" / "community_export.jsonl"
...
async def prepare_community_export() -> str:
    ...
    Data is written to ~/.chuzom/community_export.jsonl.
