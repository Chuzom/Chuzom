"""Host adapters — wire Chuzom's MCP server into each supported CLI.
...
The MCP server (chuzom-sse or chuzom stdio) does the actual work.
"""
from chuzom.hosts.base import HostAdapter
