"""Helicone integration for chuzom.

When ``HELICONE_API_KEY`` is set, chuzom can:
  ...
  **Pull** — query Helicone's usage API to get per-model spend data,
  ...
  traffic is routed outside chuzom (e.g. direct SDK calls from your
...
Optional::
    ...
    export CHUZOM_HELICONE_PULL=true   # pull spend data (default: false)
...
_PULL_ENABLED_ENV = "CHUZOM_HELICONE_PULL"
