...
from chuzom.capabilities import is_safe_path
from chuzom.token_budget import estimate_tokens

log = logging.getLogger("chuzom.code_context")
...
def extract_code_context(
    ...
    # primitive rather than merely a path bug — forwarding context is chuzom's
    # whole job.
    #
