...
MONEY_MODULES = (
    ...
    "src/chuzom/hooks/session-end.py",
)
...
#: signed sibling -- see chuzom.savings.GROSS_POTENTIAL_RATIONALE. Keep this
...
def main() -> int:
    ...
    print(
        "\nUse chuzom.savings.net_saved(baseline, actual), which is signed. A loss "
