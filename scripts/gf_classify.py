...
REPO = pathlib.Path.home() / "Projects/Chuzom"
STDOUT = REPO / ".chuzom/gf/baseline/mutmut_stdout.txt"
GF = REPO / ".chuzom/zero-tolerance-audit/gf"
...
NAME = re.compile(r"^chuzom\.(?P<mod>[\w.]+)\.x_(?P<fn>.+)__mutmut_(?P<n>\d+)$")
