...
Any file that reads `CHUZOM_OLLAMA_URL` or `OLLAMA_BASE_URL` must also reference
...
SRC = Path(__file__).resolve().parent.parent / "src" / "chuzom"

ENV_VARS = ("CHUZOM_OLLAMA_URL", "OLLAMA_BASE_URL")
...
def main() -> int:
    ...
    if offenders:
        ...
        print(
            ...
            "\n\nRoute the value through chuzom.config.validate_ollama_url — imported,"
