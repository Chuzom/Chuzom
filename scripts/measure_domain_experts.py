...
from chuzom.contamination_audit import hash_set, prompt_hash  # noqa: E402
...
def main() -> int:
    ...
    if not key:
        print("OPENROUTER_API_KEY missing in ~/.chuzom/.env", file=sys.stderr)
        return 1
    ...
    Path("src/chuzom/data/domain_expert_measurements.json").write_text(
