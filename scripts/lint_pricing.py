#!/usr/bin/env python3
"""INV-COST-004 — model prices live in chuzom.pricing and nowhere else.
...
ALLOWED: dict[str, str] = {
    ...
    "chuzom/benchmark/": "benchmark fixtures record historical prices as measured data, not live rates",
}
                ...
                if _looks_like_price_name(name) and isinstance(
                    ...
                    out.append(
                        Violation(
                            ...
                            f"Import from chuzom.pricing instead.",
                        )
                    )
...
def main() -> int:
    ...
    if args.update_baseline:
        BASELINE_PATH.write_text(
            "# INV-COST-004 accepted debt — price tables not yet migrated to chuzom.pricing.\n"
    ...
    for v in new.values():
        print(v)
    print(
        "\nModel prices belong in src/chuzom/pricing.py. Import from there:\n"
