...
#: Pre-remediation SHA from .chuzom/zero-tolerance-audit/00_AUDIT_BASELINE.md.
...
MUTATIONS: list[Mutation] = [
    # ── money ────────────────────────────────────────────────────────────────
    Mutation(
        "M1", "money", "src/chuzom/pricing.py",
    ...
    Mutation(
        ...
        "chuzom.pricing fallback absorbed -- an equivalent mutant that changed no "
    ...
    Mutation(
        "M4", "money", "src/chuzom/pricing.py",
    ...
    # ── routing ──────────────────────────────────────────────────────────────
    Mutation(
        "M5", "routing", "src/chuzom/tool_surface.py",
    ...
    Mutation(
        "M6", "routing", "src/chuzom/router.py",
    ...
    Mutation(
        "M7", "routing", "src/chuzom/router.py",
    ...
    Mutation(
        "M8", "verification", "src/chuzom/coverage.py",
    ...
    Mutation(
        "M9", "verification", "src/chuzom/coverage.py",
    ...
    Mutation(
        "M10", "verification", "src/chuzom/execution_ledger.py",
