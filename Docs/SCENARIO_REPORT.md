...
**Status:** ✅ PASS · **Duration:** 10 ms · **CLI:** `claude-code` · **Framework:** `agno`
...
2. **🪑 [session]** session opened
     · session_id='d1b3cf07' · budget=0.5 · state='active'
...
6. **📜 [lineage]** record persisted
     · session_id='d1b3cf07' · step_index=0
...
10. **📜 [lineage]** record persisted
     · session_id='d1b3cf07' · step_index=1
...
14. **📜 [lineage]** record persisted
     · session_id='d1b3cf07' · step_index=2
...
**Status:** ✅ PASS · **Duration:** 16 ms · **Framework:** `*all*`
...
1. **🪑 [session]** parent session opened
     · session_id='82819401' · role='orchestrator'
...
1. **🪑 [session]** session A opened (agno)
     · sid='8d928e1f' · budget=0.5
2. **🪑 [session]** session P opened (pydantic-ai)
     · sid='cf90bb93' · budget=0.3
3. **🧱 [framework]** audit
